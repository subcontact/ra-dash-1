export default {
  persons: [
    {
      id: 1,
      fullname: "Celina Rotman",
      name: "Celina",
      lastname: "Rotman",
      individual_id: "21749910",
      gender: "female",
      birthdate: new Date("1989-08-02"),
    ...
    {
      id: 2,
      fullname: "Victoria Zareno",
      name: "Victoria",
      lastname: "Zareno",
      individual_id: "21749920",
      gender: "female",
  ...
  resources: [
    {
      Id_Cliente_Externo: "801736",
      Nombre_de_la_oferta: "",
      Contrato_Externo: "",
      Contrato_Legal: "256K LTE (2FF/3FF4FF) CLARO - 18 Meses",
      SimCard: "798383",
      Imei: "993237",
      Numero_de_referencia: "89507030014103877513",
      Codigo_de_Cliente: "50762172790",
      Aprovisionado: "1.242711"
    }
  ],
  ...
  interactions: [
    {
      id: 1,
      friendly_name: "Zareno Victoria - New Purchase ",
      type: "Sale",
      status: "In Progress",
      created_at: new Date("2018-11-02")
    },
    {
      id: 2,
      friendly_name: "Montes Juan - New Purchase ",
      type: "Sale",
      status: "In Progress",
      created_at: new Date("2018-11-02")
    },
    {
      id: 3,
      friendly_name: "Palacios Roberto- SIM card change ",
      type: "Sale",
      status: "In Progress",
      created_at: new Date("2018-11-02")
    },
    {
      id: 4,
      friendly_name: "Gonzales José - Offer change ",
      type: "Sale",
      status: "Cancelled",
      created_at: new Date("2018-11-02")
    },
    {
      id: 5,
      friendly_name: "Martinez Ana - New Purchase ",
      type: "Sale",
      status: "In Progress",
      created_at: new Date("2018-11-02")
    },
    {
      id: 6,
      friendly_name: "Ramirez María - New Purchase ",
      type: "Sale",
      status: "In Progress",
      created_at: new Date("2018-11-02")
    },
    {
      id: 7,
      friendly_name: "Diaz Eva - New Purchase ",
      type: "Sale",
      status: "Done",
      created_at: new Date("2018-11-02")
    }
  ...
  // ==========================INDIVIDUALS ========================
  // New data model for individual - JM
  individuals: [
    {
      //Identity
      id: 1,
      ...
      id_number: "21749920",
      id_province: "Florida",
      id_district: "Fort Lauderdale",
      individual_id: "21749920", // deprecado
      //Demographic Data
      fullname: "Victoria Zareno", //deprecado
      name: "Victoria",
      lastname: "Zareno",
      gender: "Female",
      birthdate: "01/01/1991",
      nationality: "Spaniard",
      country_of_birth: "Spain", //deprecado
      marital_status: "Single",
      online_invoice: true,
      promotion_acceptance: false,

      //Invoice Adresses
      invoice_country: "Spain",
      invoice_province: "Madrid",
      invoice_district: "Alcobendas",
      invoice_neighborhood: "NA",
      invoice_address: "",
      invoice_additional_info: "",

      //Installation Adresses
      installation_country: "Spain",
      installation_province: "Madrid",
      installation_district: "Alcobendas",
      installation_neighborhood: "NA",
      installation_address: "",
      installation_additional_info: "",

      //Laboral Information
      labor_place: "Claro",
      labor_address: "Calle Antigua 32, Zona roja, Madrid",
      labor_antiquity: "0 a 1 año",
      labor_incomes: "0 a 1000 euros",

      //Additional Information
      type_of_property: "Rented",
      property_antiquity: "0 a 1 year",

      //Payment Method
      payment_method: "Cash",

      //Personal References of the Customer

      reference1_name: "John Doe",
      reference1_address: "23 Street 43, FL, 30010",
      reference1_Phone: "+ 1 423 42 2523",
      reference1_Relation: "Father",

      reference2_name: "Steve Doe",
      reference2_address: "23 Street 43, FL, 30010",
      reference2_Phone: "+ 1 423 42 2522",
      reference2_Relation: "Brother",

      reference3_name: "Mary Doe",
      reference3_address: "23 Street 43, FL, 30010",
      reference3_Phone: "+ 1 423 42 2363",
      reference3_Relation: "Mother",
    ...
    },
    {
      ...
      id_province: "Florida",
      id_district: "Fort Lauderdale",
      individual_id: "99912349", // deprecado
      //Demographic Data
      fullname: "Brad Pitty", //deprecado
      name: "Brad",
      lastname: "Pitty",
      gender: "Male",
      birthdate: "01/01/1988",
      nationality: "US citizen",
      country_of_birth: "USA", //deprecado
      marital_status: "Single",
      online_invoice: true,
      promotion_acceptance: false,
  ...
  // ==========================ACCOUNTS ========================
  // New data model for accounts - JM
  accounts: [
    {
      //Identity
      id: 1,
      ...
      account_billcycle: "cycle 01",
      account_invoice_address: "Anabel Segura 16, Alcobendas, Spain",
      account_install_address: "Anabel Segura 16, Alcobendas, Spain",
  ...
  issues: [
    {
      id: 1,
      title: "Victoria qui nihil voluptatum quia voluptas maxime ab similique",
      teaser:
        "In facilis aut aut odit hic doloribus. Fugit possimus perspiciatis sit molestias in. Sunt dignissimos sed quis at vitae veniam amet. Sint sunt perspiciatis quis doloribus aperiam numquam consequatur et. Blanditiis aut earum incidunt eos magnam et voluptatem. Minima iure voluptatum autem. At eaque sit aperiam minima aut in illum.",
      body:
  ...
  products: [
    {
      id: 1,
      offer: "Plan todo incluido $60",
      oneTimeAmount: "",
      recurrentAmount: "$60",
      description: "Plan todo incluido $60"
    },
    {
      id: 2,
      offer: "Garantía extendida",
      oneTimeAmount: "",
      recurrentAmount: "$13",
      description: "cliente Oro"
    },
    {
      id: 3,
      offer: "GPRS",
      oneTimeAmount: "",
      recurrentAmount: "$34",
      description: "servicio incluido"
    },
    {
      id: 4,
      offer: "WhatsApp ilimitado",
      oneTimeAmount: "",
      recurrentAmount: "$2",
      description: " sin coste de navegación"
    },
    {
      id: 5,
      offer: "beneficio sin fronteras",
      oneTimeAmount: "",
      recurrentAmount: "$5",
      description: "descuentos premium"
    }
  ],
  ...
  addresess: [
    {
      ...
      streetName: "Oceans Eleven",
      streetNumber: "567",
      addressLine2: "apartment 378",
      zipCode: "2342",
      city: "Michigan",
      country: "USA",
      created_at: new Date("2012-08-02")
    },
    {
      ...
      author: {},
      streetType: "Street",
      streetName: "Oceans Twelve",
      streetNumber: "789",
      addressLine2: "Block 21",
      zipCode: "2342",
      city: "Michigan",
      country: "USA",
      created_at: new Date("2012-08-02")
    ...
    },
    {
      ...
      author: {},
      streetType: "Boulevard",
      streetName: "Broken Dreams",
      streetNumber: "34A",
      addressLine2: "apartment 7589",
      zipCode: "876543",
      city: "Michigan",
      country: "USA",
      created_at: new Date("2012-08-02")
  ...
  searchEngines: [
    {
      id: 0,
      name: "Data Model Customer-Address",
      version: "v01.0",
      customerProperties: [1, 2, 3],
      addressProperties: [0, 1]
    },
    {
      id: 1,
      name: "Data Model Customer",
      version: "v01.0",
      customerProperties: [0, 1, 2, 3],
      addressProperties: [0, 1]
    }
  ],
